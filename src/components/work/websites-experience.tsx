  ...
  return (
    <div className="flex h-full flex-col">
      <div className="shrink-0 px-6 pb-6 pt-16 text-center sm:pt-20">
        ...
        <h2 className="mt-4 text-3xl font-semibold text-navy-foreground sm:text-4xl">Websites</h2>
      ...
      <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-10 sm:px-8">
        <div className="mx-auto flex max-w-4xl flex-col gap-5">
          {SITES.map((site) => (
            <div
              key={site.slug}
              className="flex flex-col overflow-hidden rounded-3xl border border-white/10 bg-white/5 shadow-elevated sm:flex-row"
            >
              <div className="flex h-44 shrink-0 items-center justify-center bg-orbit-gradient sm:h-auto sm:w-64">
              ...
              <div className="flex flex-1 flex-col justify-center p-6 text-left sm:p-8">
                ...
                <p className="mt-2 text-sm text-navy-foreground/70">{site.summary}</p>
